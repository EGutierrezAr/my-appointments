  ...
  <div class="card-body">
    ...
    <form action="{{ url('/appointments') }}" method="post">
      ...
      <div class="form-group">
        ...
        <input name="description" value="{{ old('description') }}" id="description" f type="text" class="form-control" placeholder="Describe brevemente la consulta" required>
      </div>  
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <select name="doctor_id" id="doctor" class="form-control" required>
            ...
            <option value="{{ $doctor->id }}" @if(old('doctor.id')== $doctor->id) selected @endif>{{ $doctor->name }}</option>
            @endforeach
          </select>
        </div>
      </div> 
