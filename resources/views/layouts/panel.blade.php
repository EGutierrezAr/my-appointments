...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./home">Panel de Aministración</a>
        <!-- Form -->
              ...
              <div class="card card-stats mb-3 mb-xl-0">
                <div class="card-body">
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    ...
                    <span class="text-nowrap">Vs el mes anterior</span>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    ...
                    <span class="text-nowrap">Vs Semana anterior</span>
                  </p>
                </div>
              </div>
            </div>
